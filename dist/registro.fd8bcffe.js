...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/registro.js":[function(require,module,exports) {
...
document.getElementById("btnRegistrar").addEventListener("click", registrarSocio);
function registrarSocio() {
  return _registrarSocio.apply(this, arguments);
}
function _registrarSocio() {
  _registrarSocio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var datos, repetirPassword, valido, request;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          repetirPassword = document.getElementById('repPass').value;
          valido = true;
          if (!datos.nombre) {
          ...
          _context.next = 16;
          return fetch('http://localhost:8080/api/registro', {
            method: 'POST',
            headers: {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/registro.js"], null)
//# sourceMappingURL=/registro.fd8bcffe.js.map